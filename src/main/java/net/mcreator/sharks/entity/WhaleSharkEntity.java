...
public class WhaleSharkEntity extends Animal implements GeoEntity {
	...
	public static final EntityDataAccessor<Boolean> DATA_Sprinting = SynchedEntityData.defineId(WhaleSharkEntity.class, EntityDataSerializers.BOOLEAN);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		return WhaleSharkRightClickedOnEntityProcedure.execute(world, x, y, z, entity, sourceentity);
	}
