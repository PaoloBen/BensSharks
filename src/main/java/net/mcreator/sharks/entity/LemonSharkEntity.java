...
public class LemonSharkEntity extends Animal implements GeoEntity {
	...
	public static final EntityDataAccessor<Boolean> DATA_Sprinting = SynchedEntityData.defineId(LemonSharkEntity.class, EntityDataSerializers.BOOLEAN);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		return LemonSharkRightClickedOnEntityProcedure.execute(world, x, y, z, entity, sourceentity);
	}
