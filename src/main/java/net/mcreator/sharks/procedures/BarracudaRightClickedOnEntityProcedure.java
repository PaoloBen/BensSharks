...
public class BarracudaRightClickedOnEntityProcedure {
    public static InteractionResult execute(LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
        ...
        if (entity instanceof BarracudaEntity && sourceentity instanceof Player player) {
            // No baby check here, matching your original file
            return SharkBucketHelperProcedure.catchFish(entity, player, world, BenssharksModItems.BARRACUDA_BUCKET.get());
        }
