...
public class WhaleSharkOnEntityTickUpdateProcedure {
    @SubscribeEvent
    ...
    public static void execute(Entity entity) {
        ...
        WhaleSharkEntity shark = (WhaleSharkEntity) entity;
        ...
        if (!entity.level().isClientSide()) {
            ...
            shark.getEntityData().set(WhaleSharkEntity.DATA_Sprinting, active);
            if (active) shark.addEffect(new MobEffectInstance(BenssharksModMobEffects.FRENZY.get(), 10, 0, false, false));
        }

        if (shark.getEntityData().get(WhaleSharkEntity.DATA_Sprinting)) {
