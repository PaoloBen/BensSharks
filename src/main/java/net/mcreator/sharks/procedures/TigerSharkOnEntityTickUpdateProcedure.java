...
public class TigerSharkOnEntityTickUpdateProcedure {
    ...
    public static void execute(Entity entity) {
        ...
        TigerSharkEntity shark = (TigerSharkEntity) entity;
        ...
        if (!entity.level().isClientSide()) {
            ...
            shark.getEntityData().set(TigerSharkEntity.DATA_Sprinting, active);
            if (active) shark.addEffect(new MobEffectInstance(BenssharksModMobEffects.FRENZY.get(), 10, 0, false, false));
        }

        if (shark.getEntityData().get(TigerSharkEntity.DATA_Sprinting)) {
