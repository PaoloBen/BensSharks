...
public class BullSharkOnEntityTickUpdateProcedure {
    @SubscribeEvent
    ...
    public static void execute(Entity entity) {
        ...
        BullSharkEntity shark = (BullSharkEntity) entity;
        ...
        if (!entity.level().isClientSide()) {
            ...
            shark.getEntityData().set(BullSharkEntity.DATA_Sprinting, active);
            if (active) shark.addEffect(new MobEffectInstance(BenssharksModMobEffects.FRENZY.get(), 10, 0, false, false));
        }

        if (shark.getEntityData().get(BullSharkEntity.DATA_Sprinting)) {
