...
public class BlacktipReefSharkOnEntityTickUpdateProcedure {
    ...
    public static void execute(Entity entity) {
        ...
        BlacktipReefSharkEntity shark = (BlacktipReefSharkEntity) entity;
        ...
        if (!entity.level().isClientSide()) {
            ...
            shark.getEntityData().set(BlacktipReefSharkEntity.DATA_Sprinting, active);
            if (active) shark.addEffect(new MobEffectInstance(BenssharksModMobEffects.FRENZY.get(), 10, 0, false, false));
        }

        if (shark.getEntityData().get(BlacktipReefSharkEntity.DATA_Sprinting)) {
